...
import { ShoppingBag, Package, DollarSign, Truck, Grid, Tag } from 'lucide-react';
...
export default function BuyerDashboard() {
  ...
  const loadDashboardData = async () => {
    ...
    const totalSpent = orderList.reduce((sum, o) => sum + (parseFloat(o.total_amount) || 0), 0);
  ...
  return (
    <div className="space-y-6">
      <div>
        ...
        <p className="text-slate-600 mt-1">Welcome back, {profile?.first_name}!</p>
      </div>
        ...
        <div className="bg-white rounded-xl border border-slate-200 p-6">
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-3xl font-bold text-slate-900">{stats.deliveredOrders}</p>
            </div>
        ...
        <div className="bg-white rounded-xl border border-slate-200 p-6">
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-3xl font-bold text-slate-900">{stats.brandsCount}</p>
            </div>
            <div className="w-12 h-12 bg-yellow-100 rounded-xl flex items-center justify-center">
